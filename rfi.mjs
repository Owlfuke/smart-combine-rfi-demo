...
import {cloud,RFI_PDF_CLOUD_STROKE,RFI_PDF_CLOUD_IMAGE_VERSION,rfiPdfCloudShape} from './rfi-cloud.mjs';
...
function renderCurrentRfiImage(engine,item){
 ...
 try{
  ...
  cloud(ctx,{x:pad,y:pad,w:region.w-pad*2,h:region.h-pad*2},RFI_PDF_CLOUD_STROKE/scale,rfiPdfCloudShape({w:region.w-pad*2,h:region.h-pad*2}));
