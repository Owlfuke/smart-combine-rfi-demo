...
export function installRfi({engine,getProject,mutate,schedule,toast}){
 ...
 const registerDock=installRegister({getProject,mutate,toast,open:item=>{refresh();show(item);$('rfi-list').value=item.id;}});
