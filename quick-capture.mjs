...
export function chooseCrop(source,title='Crop ภาพก่อนนำเข้า'){
 ...
 const maxWidth=Math.max(320,Math.min(1100,window.innerWidth-100)),maxHeight=Math.max(220,Math.min(650,window.innerHeight-280)),scale=Math.min(1,maxWidth/source.width,maxHeight/source.height);
