...
export class Engine {
  ...
  cursor(){this.canvas.style.cursor=this.drag?"grabbing":this.p?.calibration&&this.stage()!=="review"?"none":this.p?.panMode?"grab":(["scale","distance","arrow"].includes(this.measureMode)||this.markupMode)?"crosshair":"default";}
  resize(){
